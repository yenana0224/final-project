            ...
            <form action="insert.notice" method="post">
				<table class="tb_input">
					<tbody>
						...
						<tr>
							<th>* 동행 날짜</th>
							<td><input type="date" name="accompanyDate" class="date_input"></td>
						</tr>
                        <tr>
							<th>* 모집 인원</th>
							<td><input type="number" min="1" max="10" name="people" class="people_input"/>
						...
						<tr>
							<th>* 내용</th>
							<td><textarea class="input_content" name="content"></textarea></td>
						</tr>
					</tbody>
				</table>
